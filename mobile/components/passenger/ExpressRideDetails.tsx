...
import { EXPRESS_RIDE_CONTENT as C } from "@/lib/express-ride-content";
import Ionicons from "@expo/vector-icons/Ionicons";
import { StyleSheet, Text, View } from "react-native";

/** Full Express Ride details body — no map, no booking controls. */
export function ExpressRideDetails() {
  return (
    <View style={styles.wrap}>
      ...
      <Text style={styles.section}>What is Express?</Text>
      ...
      <Text style={styles.section}>Why choose Express?</Text>
