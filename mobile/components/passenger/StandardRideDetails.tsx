...
import { STANDARD_RIDE_CONTENT as C } from "@/lib/standard-ride-content";
import Ionicons from "@expo/vector-icons/Ionicons";
import { StyleSheet, Text, View } from "react-native";

/** Full Standard Ride details body — no map, no booking controls. */
export function StandardRideDetails() {
  return (
    <View style={styles.wrap}>
        ...
        {C.highlights.map((h) => (
          <View key={h.label} style={styles.highlightItem}>
            <View style={styles.highlightIcon}>
              <Ionicons name={h.icon} size={18} color={colors.primary} />
            </View>
      ...
      <Text style={styles.section}>Why choose Standard?</Text>
...
const styles = StyleSheet.create({
  ...
  specValue: { fontSize: 14, fontWeight: "500", color: colors.dark },
});
